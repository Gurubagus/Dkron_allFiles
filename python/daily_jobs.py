...
def main():
	try:
		...
		stdin, stdout, stderr = ssh_client.exec_command("/usr/bin/bash -lc '/etl/cronjobs/daily_jobs.sh' 1>/dev/null 2>/etl/logs/daily_jobs.txt")
		out = stdout.read()
		print(out)
...
if __name__ == '__main__':
	try:
		...
		emailer.raise_error("daily_jobs ERROR","The daily_jobs execution time has exceeded the 10 minute safety limit")