...
def main():
	try:
		...
		stdin, stdout, stderr = ssh_client.exec_command("/usr/bin/bash -lc '/etl/cronjobs/15minute_jobs.sh' 1>/dev/null 2>/etl/logs/15minute_jobs.txt")
		out = stdout.read()
		print(out)
...
if __name__ == '__main__':
	try:
		...
		emailer.raise_error("15minute_jobs ERROR","The 15minute_jobs execution time has exceeded the 16 minute safety limit")